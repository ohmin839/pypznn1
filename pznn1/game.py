...
if __name__ == "__main__":
    ...
    parser.add_argument("--size", type=int, default=3, help="Specifies the height and width")
    parser.add_argument("--shuffles", type=int, default=31, help="Specifies the count of shuffles")
