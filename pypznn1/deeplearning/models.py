...
from pypznn1.deeplearning import Layer
...
class ResNet(Model):
    ...
    def __init__(self, n_layers=152, pretrained=False):
        ...
        if n_layers == 50:
            ...
            raise ValueError(f'The n_layers argument should be either 50, 101, or 152, but {n_layers} was given.')
...
class BuildingBlock(Layer):
    def __init__(self, n_layers=None,
                 in_channels=None, mid_channels=None, out_channels=None,
                 stride=None, downsample_fb=None):
        super().__init__()
